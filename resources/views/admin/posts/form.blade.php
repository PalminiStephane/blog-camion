{{-- 
    ...
    Ce formulaire permet à l'utilisateur de créer un nouveau post en fournissant les informations nécessaires telles que le titre, le contenu, l'image de couverture, la catégorie et les étiquettes.
    Le formulaire est soumis à l'URL de la route 'admin.posts.store' via la méthode POST.
--}}
